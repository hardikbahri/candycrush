...
void Movepart()
{
    ...
    int linesource = moves.source.first;
    int columnsource = moves.source.second;

    int linedestination = moves.destination.first;
    int columndestination = moves.destination.second;
